...
__C.PYTRACKING.PARAM_DIR = 'pytracking/parameter/dimp/'

__C.PYTRACKING.TRACKER_NAME = 'dimp'

__C.PYTRACKING.PARAM_NAME = 'dimp50'

__C.PYTRACKING.SHOW = False
...
__C.SIAMDW = CN()
__C.SIAMDW.MODEL_PATH="./extern/siamdw/models/CIResNet22_PRETRAIN.model"
__C.SIAMDW.scale_step = 1.1897
__C.SIAMDW.scale_lr = 0.2226
__C.SIAMDW.scale_penalty = 0.9370
__C.SIAMDW.w_influence = 0.2897
__C.SIAMDW.instance_size = 263
...
__C.CFTRACKING.TRACKER_TYPE = 'kcf'

__C.CFTRACKING.SHOW = False