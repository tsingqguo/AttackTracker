...
import math
import time
from extern.pytracking.libs import dcf, fourier, TensorList, operation
...
from extern.pytracking.libs.optimization import GaussNewtonCG, ConjugateGradient, GradientDescentL2
from extern.pytracking.utils.optim import ConvProblem, FactorizedConvProblem
from extern.pytracking.features import augmentation


class ATOMTracker(pyBaseTracker):
    ...
    def track(self, image,x_crop=[],ispert=False) -> dict:
        self.debug_info = {}
